...
public class Escenario1HimnoAlegriaTest {
    ...
    public void debeTocarEscenario1() throws InterruptedException {
        ...
        // Tocar la secuencia del Himno de la Alegría
        TocarSecuencia tocarSecuencia = new TocarSecuencia(driver, SecuenciaHimno.escenario1());
